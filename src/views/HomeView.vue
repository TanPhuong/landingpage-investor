      ...
      <div class="reason_container p-120">
        ...
        <div class="reason-item_container d-flex justify-content-between text-center">
          ...
          <div class="reason-item ">
            ...
            <div class="description mt-4">Tham gia với mức đầu tư thấp <span
          ...
          <table class="table mx-auto">
            <thead>
              <tr>
                ...
                <th scope="col" class="investment-title_col page-gradient-pink text-white fs-4 aver-bold"> Đầu tư vào quỹ Vietnam Tourist
                </th>
              </tr>
            </thead>
    ...
    <div id="representative_section">
      <div class="representative_container p-120 d-flex align-items-center justify-content-center">
        <div class="commit_container">
          ...
          <div class="commit-text aver-bold fs-1">Vietnam Tourist cam kết luôn đồng hành và
