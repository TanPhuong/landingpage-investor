  ...
  <main>
    ...
    <div id="reason_section" class="section-scroll-margin m-side-100">
      <div class="reason_container p-120">
        <div class="title-section text-center aver-bold page-text-gradient" style="margin-bottom: 52px;">
        ...
        <div class="reason-item_container d-flex justify-content-between text-center">
          ...
          <div class="reason-item">
            ...
            <div class="description mt-4" style="margin: auto;"><span class="aver-semi-bold">Tăng trưởng tài sản</span>
          ...
          <div class="reason-item">
            ...
            <div class="description mt-4" style="margin: auto;">Tỷ suất lợi nhuận hấp dẫn lên đến
          ...
          <div class="reason-item ">
            ...
            <div class="description mt-4" style="margin: auto;">Tập trung kinh doanh và sự nghiệp mà vẫn
          ...
          <div class="reason-item ">
            ...
            <div class="description mt-4" style="margin: auto;">Tham gia với mức đầu tư thấp <span
          ...
          <table class="table" style="margin: auto; width: 80%;">
            ...
            <tbody>
              <tr v-for="(item, index) in data" :key="index">
                <th scope="row" class="fs-5 aver-semi-bold" style="padding:20px 32px;">{{ item.title }}</th>
                <td class="aver-regular" style="font-size: 18px; padding:24px 32px;">{{ item.economicDetail }}</td>
                <td class="investment-item page-gradient-pink text-white aver-semi-bold"
                  style="font-size: 18px; padding: 24px 40px;">{{ item.invesmentDetail }}</td>
              </tr>
            </tbody>
          </table>
        </div>
    ...
    <div id="growth_section">
      <div class="growth_container d-flex justify-content-center align-items-end m-side-100">
        ...
        <div class="img-section" v-if="!props.mobileView" style="max-width: 382px;">
