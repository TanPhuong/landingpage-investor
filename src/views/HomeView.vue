        ...
        <div class="privilege-item_container row text-center text-white my-5">
          <div class="privilege-item col">
            ...
            <div class="desc-wrapper">
              ...
              <div class="desc-privilege w-75 fs-5 mt-2 aver-light" style="margin: auto;">Cổ đông trở thành khách VIP,
                nhận ngay ưu
          ...
          <div class="privilege-item col">
            ...
            <div class="desc-wrapper">
              ...
              <div class="desc-privilege w-75 fs-5 mt-2 aver-light" style="margin: auto;">Mức hoa hồng hấp dẫn, được đào
                tạo kỹ
                năng
          ...
          <div class="privilege-item col">
            ...
            <div class="desc-wrapper">
              ...
              <div class="desc-privilege w-75 fs-5 mt-2 aver-light" style="margin: auto;">Trải nghiệm những chuyến du
                lịch miễn phí
